                ...
                <div class="row">
                    ...
                    <div class="col-xs-8 text-right menu-1">
                        <ul>
                            ...
                            <li class="active"><a href="home.php">mypage</a></li>
            ...
            <div class="row row-bottom-padded-md">
                <div class="col-md-12">
                    ...
                    <li class="one-third animate-box" data-animate-effect="fadeIn" style="background-image: url(assets/images/gallery-4.jpg); ">
                        ...
                        <li class="one-third animate-box" data-animate-effect="fadeIn" style="background-image: url(assets/mages/gallery-6.jpg); ">
                            <a href="#" class="color-4">
                                <div class="case-studies-summary">
                                 <h2>商品名</h2>
                                </div>
